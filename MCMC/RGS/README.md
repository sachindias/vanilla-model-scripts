...
The contents of the subfolder are concerned with therunning of MCMC scripts RGS data. 
...
1. **The models** - These are example RGS XPEC models, for ```ISMabs * (SIMPL * KERRBB)```. 
