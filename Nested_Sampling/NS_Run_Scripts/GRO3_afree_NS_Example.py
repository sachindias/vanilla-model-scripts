...
os.chdir('spectra/GRO_J1655_40/rev0964b')
...
xspec.AllData("rev0964b_cor_PN_spectrum_grp.fits")
...
#CREATE A MODEL   
model = xspec.Model("constant * ismabs * (simpl * kerrbb + relxillcp) * gabs * gabs * gabs * gabs") 
