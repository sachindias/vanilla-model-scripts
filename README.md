...
**GROj1655-40_Paper:** code to generate tables and figures for the paper applying the 'vanilla' model to GRO J1655-40.
...
**Nested_Sampling:** code to perform Nested Sampling analysis across four examples, with custom truncated priors for gamma, isotropic (sin), and lognormal distributions.
